...
def get_model(units=8, time_step=32):
    ...
    enc_output = tf.keras.layers.LSTM(units,return_sequences=True, recurrent_initializer='glorot_uniform')(conv_)

    dec_output = tf.keras.layers.LSTM(units, recurrent_initializer='glorot_uniform')(enc_output)
